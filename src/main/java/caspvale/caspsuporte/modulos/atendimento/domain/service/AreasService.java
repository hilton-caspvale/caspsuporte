...
import caspvale.caspsuporte.modulos.atendimento.exception.AreaNaoEncontradaException;
import caspvale.caspsuporte.modulos.atendimento.domain.repository.AreasRepository;
