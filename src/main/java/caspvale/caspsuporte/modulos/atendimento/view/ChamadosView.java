...
import caspvale.caspsuporte.modulos.atendimento.api.controller.ChamadosController;
...
import caspvale.caspsuporte.modulos.atendimento.api.controller.PrioridadesController;
import caspvale.caspsuporte.modulos.atendimento.api.controller.SistemasController;
import caspvale.caspsuporte.modulos.atendimento.api.controller.UsuariosController;
import caspvale.caspsuporte.modulos.atendimento.api.model.AnexosInputModel;
...
import caspvale.caspsuporte.modulos.atendimento.api.model.ProblemasInputModel;
...
import caspvale.caspsuporte.modulos.atendimento.view.common.ViewObjects;
            ...
            switch (chamado.getISituacao().getDescricaoSituacao()) {
                case "AGUARDANDO ATENDIMENTO":
                    if (role.equals("ANALISTA")) {
                        ...
                        if (Objects.equals(chamado.getIUsuarioAbertura().getIUsuario(), usuarioLogado.getIUsuario())) {
