...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/private/gestao/**").hasAnyAuthority("ADMINISTRADOR", "ANALISTA")
                .antMatchers("/mv/atendimento-cliente/**").hasAnyAuthority("CLIENTE", "ANALISTA", "ADMINISTRADOR")
                .antMatchers("/mv/atendimento/**").hasAnyAuthority("ADMINISTRADOR", "ANALISTA")
