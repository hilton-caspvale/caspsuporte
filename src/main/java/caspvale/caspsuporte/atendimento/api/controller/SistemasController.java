...
import caspvale.caspsuporte.atendimento.api.assembler.SistemasAssembler;
...
import caspvale.caspsuporte.atendimento.domain.service.SistemasService;
...
public class SistemasController {
    ...
    public ResponseEntity deletar(@PathVariable Integer iSistema) {
        ...
        return ResponseEntity.status(HttpStatus.NO_CONTENT).body(sistemasAssembler.toModel(new CaspSistemas()));
    }
}
